...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2019 a las 13:17:41
...
(6, 17, '2019-10-30', '2019-10-31', 2, '2019-10-10', '05:53:24', '30 al 31 de Octubre del 2019', 1, 1, 0, 0);
...
--
ALTER TABLE `tbl_rasolicitud`
  MODIFY `CodRAS` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `tbl_solicitud`
--
ALTER TABLE `tbl_solicitud`
  MODIFY `CodSol` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
