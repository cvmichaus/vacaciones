...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2019 a las 18:53:07
...
(13, 13, 'carlos valentin', 'michuas', 'barcenas', 'desarrollador', 'TI', '5', '', '2017-02-02', 2, 7, 26, 4);
...
(1, 2, 2, 'FELICIDADES', 13, '2019-09-30', '00:12:06', 1),
(2, 2, 2, 'FELICIDADES', 13, '2019-09-30', '00:21:05', 1),
(3, 2, 2, 'FELICIDADES', 13, '2019-09-30', '00:21:05', 1),
(4, 2, 2, 'FELICIDADES', 13, '2019-09-30', '00:24:44', 1),
(5, 2, 2, 'FELICIDADES', 13, '2019-09-30', '00:24:44', 1),
(6, 2, 2, 'FELICIDADES', 13, '2019-09-30', '00:26:21', 1);
...
(2, 13, '2019-09-30', '2019-10-04', 1, '2019-09-28', '18:41:19', '30 de sep al 4 octubre', 4, 8, 4),
(3, 13, '2019-09-30', '2019-10-04', 2, '2019-09-29', '23:54:32', 'del 30 DE SEP AL 4 DE OCT', 4, 8, 4);
...
(13, 'c.michaus', 'aq+jmaCa', 'michusvalentin@gmail.com', 1, 2, '2019-09-28', '18:38:55');
...
--
ALTER TABLE `tbl_usuarios`
  MODIFY `CodUsuario` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_vacaciones_usuarioxanio`
  MODIFY `CodVac` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
